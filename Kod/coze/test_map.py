...
def get_test_map(test_number):
    ...
    test_map = {
        'Test1': 'Maps/Nowy_York_map.graphml',
        'Test2': 'Maps/Berlin_map.graphml',
        'Test3': 'Maps/Lubelskie_map.graphml',
        'Test4': 'Maps/Wroclaw_map.graphml',
        'Test7': 'Maps/Wroclaw_map.graphml',
        'Test5': 'Maps/Zalipie_map.graphml',
        'Test6': 'Maps/Zalipie_map.graphml',
        'Test10': 'Maps/Zalipie_map.graphml',
        'Test12': 'Maps/Ostrowiec_map.graphml',
        'Test11': 'Maps/Plonsk_map.graphml'
    }
